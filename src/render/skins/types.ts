...
import type { CompiledCircuit, NodeDef, Point, Pulse, SimEvent } from '../../engine'
import type { Effects } from '../fx'

export type DrawContext = { d: Graphics; gl: Graphics; time: number; circuit: CompiledCircuit }
