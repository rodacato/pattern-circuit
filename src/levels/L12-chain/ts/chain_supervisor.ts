...
class Supervisor extends Handler { // ← un eslabón nuevo; los demás no cambian
  canHandle(r: RefundRequest) { return r.amount < 1000 }
}
// endregion
...
// region: wiring
const chain = new Cashier(new Manager(new Supervisor(new Owner())))
// endregion
