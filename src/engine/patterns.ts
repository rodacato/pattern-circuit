...
export const PATTERNS: Record<PatternId, PatternInfo> = {
  ...
  builder: { name: 'Builder', family: 'creational', gist: 'Arma un objeto complejo paso a paso y lo valida al final.' },
  ...
  command: { name: 'Command', family: 'behavioral', gist: 'Una petición convertida en objeto: se encola y se deshace.' },
